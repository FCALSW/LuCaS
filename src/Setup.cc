...
G4double Setup::world_hdx = 1000. *mm;
G4double Setup::world_hdy = 1000. *mm;
...
G4double Setup::Lcal_FEChip_rmax   = Setup::Lcal_SensRadMax + Setup::Lcal_space_for_ears;
G4double Setup::Lcal_FEChip_rmin   = Setup::Lcal_SensRadMax;
